 ...
 * @author nandu
 */
public class SupDisp extends javax.swing.JFrame {

    /**
     * Creates new form SupDisp
     */
    public SupDisp() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupDisp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
